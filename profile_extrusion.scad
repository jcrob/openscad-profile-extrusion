...
//   stem root spans from left-flange inner face to right-notch inner face
...
stem_root_w   = notch_inner_x - left_flange_t;
tip_center_x  = left_flange_t + stem_root_w / 2;
...
profile_points = [
    ...
    [left_flange_t,  -top_thickness],     // underside at flange / stem root left
